...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% parameters %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Niter = 2000;
%scanNo_s = [747,749]; gpu_id = 1; %
%scanNo_s = [751:2:759]; gpu_id = 10; %
%scanNo_s = [761:2:769]; gpu_id = 6; %
%scanNo_s = [771:2:779]; gpu_id = 7; %
%scanNo_s = [781:2:789]; gpu_id = 8; %
%scanNo_s = [743]; gpu_id = 9; %
...
for i=1:length(scanNo_s)
    ...
    affine_matrix_init = [1, 0; 0 ,1];
    recon_dir = strcat('/roi1_Ndp',num2str(Ndp),'/MLs_L1_p10_g200_Ndp64_pc100_updPosWeight100_vp7_vi_Nlayers5_avg_dz8e-06_reg0.5_angle_corr0.5/Niter1500.mat');

    preReconPosFile = strcat(base_path,'fly',num2str(scanNo),recon_dir);
    clear p
    %% General
    p = struct();
    eng = struct();
    ...
    p.   scan.type = 'pre_recon';                                  % {'round', 'raster', 'round_roi', 'custom'}
    ...
    p.   scan.custom_positions_source = preReconPosFile;                     % custom: a string name of a function that defines the positions; also accepts mat file with entry 'pos', see +scans/+positions/+mat_pos.m
    ...
    p.   initial_iterate_object_file{1} = preReconPosFile;                   %  use this mat-file as initial guess of object, it is possible to use wild characters and pattern filling, example: '../analysis/S%05i/wrap_*_1024x1024_1_recons*'
    ...
    %eng. beta_LSQ = 0.1;       % use predictive step length
    ...
    [eng.fout, p.suffix] =  generateResultDir(eng, resultDir, strcat('_angle_corr',num2str(angle_correction),'_all'));
