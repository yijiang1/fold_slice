...
% ** par       structure containing position update info (description added by YJ)

% returns:
% ++ pos_update     position updates for each of the indices   
% ++ probe_rotation  rotation updates (description added by YJ)
% ++ probe_scale     scale updates (description added by YJ)
